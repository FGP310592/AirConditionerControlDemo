...
Fluids.Refrigerant.TSat(3) = 32+273.15; % [K] - Saturation temperature at condenser pressure
...
Fluids.Refrigerant.rhoL(2) = 1102; % [kg/m^3] - Liquid density at evaporator pressure
Fluids.Refrigerant.rhoL(3) = 931; % [kg/m^3] - Liquid density at condenser pressure
...
Fluids.Refrigerant.cpL(2) = 911; % [J/kg/K] - Liquid constant pressure specific heat at evaporator pressure
Fluids.Refrigerant.cpL(3) = 1201; % [J/kg/K] - Liquid constant pressure specific heat at condenser pressure
Fluids.Refrigerant.cpG(1) = 2104; % [J/kg/K] - Gas specific heat at ambient pressure
Fluids.Refrigerant.cpG(2) = 2207; % [J/kg/K] - Gas specific heat at evaporator pressure
Fluids.Refrigerant.cpG(3) = 2040; % [J/kg/K] - Gas specific heat at condenser pressure
...
Fluids.Refrigerant.hLSat(2) = 175990; % [J/kg] - Saturation liquid specific entalphy at evaporator pressure
Fluids.Refrigerant.hLSat(3) = 259280; % [J/kg] - Saturation liquid specific entalphy at condenser pressure
Fluids.Refrigerant.hGSat(1) = 516900; % [J/kg] - Saturation gas specific entalphy at ambient pressure
Fluids.Refrigerant.hGSat(2) = 511890; % [J/kg] - Saturation gas specific entalphy at evaporator pressure
Fluids.Refrigerant.hGSat(3) = 515290; % [J/kg] - Saturation gas specific entalphy at condenser pressure
% Fluids - Air
...
AC.General.p(2) = 5*101325; % [Pa] - Evaporator pressure
AC.General.p(3) = 20*101325; % [Pa] - Condenser pressure
...
% Condenser 1
AC.HXOut1.Refrigerant.NumNodes = 50; % [1]
AC.HXOut1.Refrigerant.NumPipes = 1; % [1]
AC.HXOut1.Refrigerant.L = 10; % [m]
...
% Condenser 2
AC.HXOut2.FlagPresent = false; % [-]
AC.HXOut2.Refrigerant.NumNodes = 50; % [1]
AC.HXOut2.Refrigerant.NumPipes = 1; % [1]
AC.HXOut2.Refrigerant.L = 10; % [m]
...
% Evaporator 1
AC.HXIn1.Refrigerant.NumNodes = 50; % [1]
AC.HXIn1.Refrigerant.NumPipes = 1; % [1]
AC.HXIn1.Refrigerant.L = 10; % [m]
...
% Evaporator 2
AC.HXIn2.FlagPresent = false; % [-]
AC.HXIn2.Refrigerant.NumNodes = 50; % [1]
AC.HXIn2.Refrigerant.NumPipes = 1; % [1]
AC.HXIn2.Refrigerant.L = 10; % [m]
...
AC.Controller.Room.Input.TCmd = [16,16,18,18,18]+273.15; % [K]
...
Environment1.Input.T = [1,1]*(7+273.15); % [K]
...
Environment2.Input.T = [1,1]*(0+273.15); % [K]
